...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        {
            createStaticMandelbrotImage();
            System.out.println("Finished!");
        }
        else
        {
            createMandelbrotGIF();
            System.out.println("Your gif has been generated! Enter any character to continue...");
            mainScan.next();
        }
    }
    ...
    /**
     * Generates a single jpeg image of a mandelbrot set
     */
    public static void createStaticMandelbrotImage()
    {
    ...
    /**
     * Generates an animated gif of a zoom in on a mandelbrot set
     */
    public static void createMandelbrotGIF()
    {
        Scanner mainScan = new Scanner(System.in);
